...
class AttributeConflict extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeConflict', package: const $pb.PackageName(_omitMessageNames ? '' : 'libs.common.v1'), createEmptyInstance: create)
    ..aOM<$6.Any>(1, _omitFieldNames ? '' : 'is', subBuilder: $6.Any.create)
    ..aOM<$6.Any>(2, _omitFieldNames ? '' : 'want', subBuilder: $6.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $6.Any get is_1 => $_getN(0);
  @$pb.TagNumber(1)
  set is_1($6.Any v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasIs_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearIs_1() => clearField(1);
  @$pb.TagNumber(1)
  $6.Any ensureIs_1() => $_ensure(0);

  @$pb.TagNumber(2)
  $6.Any get want => $_getN(1);
  @$pb.TagNumber(2)
  set want($6.Any v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasWant() => $_has(1);
  @$pb.TagNumber(2)
  void clearWant() => clearField(2);
  @$pb.TagNumber(2)
  $6.Any ensureWant() => $_ensure(1);
}
